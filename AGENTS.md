...
| `test_cadena_9_perfiles.py` | Encargo 04, E1 — los perfiles de destino, escritos con sus números medidos. |
...
| `test_d2_codigos.py` | D2 — VideoMesh actúa por el identificador, nunca por el mensaje. |
...
| `test_f6_pipeline.py` | El pipeline por la CLI — §20 del roadmap. |
